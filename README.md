...
```bash
download_url=https://github.com/vschwaberow/rockyou2024/releases/download/v0.8.0/search-linux-v0.8.0.zip
curl -LO "$download_url"
unzip search-linux-v0.8.0.zip -d rockyou2024-linux
```

Replace the URL with the macOS package when needed (`https://github.com/vschwaberow/rockyou2024/releases/download/v0.8.0/search-macos-v0.8.0.zip`).

### Windows

```powershell
Invoke-WebRequest -Uri https://github.com/vschwaberow/rockyou2024/releases/download/v0.8.0/search-windows-v0.8.0.zip -OutFile search-windows-v0.8.0.zip
Expand-Archive -Path search-windows-v0.8.0.zip -DestinationPath rockyou2024-windows
```
